...
<div class="container">
    ...
    <div class="form-floating mb-3">
        <input type="number" class="form-control @if($errors->has('ukuran')) is-invalid @endif" name="ukuran" id="ukuran" placeholder="" value="{{old('ukuran')}}">
    ...
    <div class="form-floating mb-3">
        <input type="number" class="form-control @if($errors->has('harga')) is-invalid @endif" name="harga" id="harga" placeholder="" value="{{old('harga')}}">
    ...
    <div class="form-floating mb-3">
    <textarea class="form-control @if($errors->has('deskripsi')) is-invalid @endif" name="deskripsi" id="deskripsi" placeholder="" style="height: 120px;">{{ old('deskripsi') }}</textarea>
...
<div class="mb-3">
        ...
        <select class="form-select @if($errors->has('kategori')) is-invalid @endif" id="kategori" name="kategori">
            ...
            <option value="{{ $k->id_kategori }}" <?php if(old('kategori') == $k->id_kategori){ echo 'selected'; } ?>>{{$k->kategori}}</option>
            @endforeach
    ...
    <div class="row">
        <div class="col-md-2">
            <img src="{{ asset('storage/foto_barang/default.png') }}" style="width: 70px; height: 70px;" class=" img-preview" alt="Preview">
        </div>
        <div class="col-md-7">
...
<script>
    function previewImg(inputId) {
        ...
        var preview = input.parentNode.previousElementSibling.querySelector('img'); // Menggunakan parentNode dan previousElementSibling untuk mencari elemen gambar
